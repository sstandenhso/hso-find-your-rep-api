...
const SALES_REPS_BLOB_FILE_NAME = process.env.REPS_BLOB_FILE_NAME || "reps.json"; // Specific file name for sales reps data
...
export async function getRepsAPI(request: HttpRequest, context: InvocationContext): Promise<HttpResponseInit> {
